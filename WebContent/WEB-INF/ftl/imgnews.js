...
function initPicPlayer(pics, w, h) {
	...
	p.text('');
	p
			.append('<div id=\"piccontent\" style=\"width:375px;height:330px;-webkit-writing-mode: vertical-lr;writing-mode: tb-lr;\"><div id="imgcontent" style=\"width:355px;height:310px;" ></div><div id="title" style="width:30px;color:#454545;height:330px;padding:5px;" class="mnlist"></div></div>');
	var c = $('#imgcontent');
