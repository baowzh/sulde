...
<body>
	...
	<div class="lmainR">
		<form action="userlist.do" method="post" id="queryForm">
			<div class="lmainR"
				style="writing-mode: tb-lr; -webkit-writing-mode: vertical-lr; height: 603px">
				<table style="border: solid 1px #eee; height: 600px;" valign="top">
					<tr>
						<td>
							...
							<div class="xldgurg" style="width: 124px; height: 470px;">
								<div class="avtr">
									<a
										...
										<img src="html/userhead/<c:out value="${userValue.headurl}"/>"
				...
				<div class="mnlist"
					style="text-align: center; height: 600px; border-bottom: solid 1px #eee; border-right: solid 1px #eee;">
