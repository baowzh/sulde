<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<div class="tailCard" style="height: 190px; padding-left: 100px;">
	<div class="msheet" style="height: 190px; width: 800px;">
		<div class="mnlist"
			style="height: 190px; width: 30px; text-indent: 8px; padding-left: 15px;">
			<a>  </a>
		</div>
		<div class="mnlist"
