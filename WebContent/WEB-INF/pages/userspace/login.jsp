			...
			<div class="loginWindow">
				<div class="content">
					<form class="mglForm" action="checkandlogin.do" id="loginform" method="post">
						...
						<div class="inputHolder"><input name="username" id="username" value="" /></div>
						<div class="inputHolder"><input name="password" id="password" type="password"/></div>
						<div class="inputHolder"><input name="varifycode" id="varifycode" value="" /></div>
						<div class="inputHolder"><input  type="button" onclick="javascript:dosubmit();" value=" "/></div>
					</form>
				</div>
			</div>
		</div>
