...
(function() {
	var r = function(c, j) {
		...
		return {
						...
						children : [{
							...
							commit : function(a, b) {
								a == f && (this.getValue() || this.isChanged())
										? (b.data("cke-saved-src", this
														.getValue()), b
												.setAttribute("src", this
																.getValue()))
										: 8 == a
												&& (b.setAttribute("src", ""), b
														.removeAttribute("src"))
							},
							validate : CKEDITOR.dialog.validate
									.notEmpty(c.lang.image.urlMissing)
						},
								/*
						 * { type : "button", id : "browse", style :
						 * "display:inline-block;margin-top:10px;",
						 * align : "center", label : " ", //
						 * label : c.lang.common.browseServer, hidden :
						 * !0, filebrowser : "info:txtUrl", onClick :
						 * function() {
						 *  // var thisDialog = this.getDialog(); var
						 * txtUrlObj = thisDialog.getContentElement(
						 * 'info', 'txtUrl'); var txtUrlId =
						 * txtUrlObj.getInputElement().$.id;
						 * //alert(top.document.getElementById('infotypeid').value);
						 * var retFile = window.showModalDialog(
						 * "locate.do?path=userspace/info_uploadImage&infotypeid=" +
						 * "aa" + "&txtUrlId=" + txtUrlId, "",
						 * "height=300, width=400"); if (retFile !=
						 * null) { this.getDialog().setValueOf('info',
						 * 'txtUrl', retFile); }
						 *  //
						 *  } }
						 */

								{
									...
									onClick : function() {
										...
										// alert(top.document.getElementById('infotypeid').value);
										var retFile = window.showModalDialog(
												"locate.do?path=userspace/imageupload&infotypeid="
														+ "aa" + "&txtUrlId="
														+ txtUrlId, "",
												"height=300, width=400");
										if (retFile != null) {
											this.getDialog().setValueOf('info',
													'txtUrl', retFile);
										}
									}
								}]
			...
			/*
			 * , { id : "Link", requiredContent : "a[href]", label :
			 * c.lang.image.linkTab, padding : 0, elements : [{ id : "txtUrl",
			 * type : "text", label : c.lang.common.url, style : "width: 100%",
			 * "default" : "", setup : function(a, b) { if (2 == a) { var c =
			 * b.data("cke-saved-href"); c || (c = b.getAttribute("href"));
			 * this.setValue(c) } }, commit : function(a, b) { if (2 == a &&
			 * (this.getValue() || this.isChanged())) { var d =
			 * decodeURI(this.getValue()); b.data("cke-saved-href", d);
			 * b.setAttribute("href", d); if (this.getValue() ||
			 * !c.config.image_removeLinkByEmptyURL) this.getDialog().addLink =
			 * !0 } } }, { type : "button", id : "browse", filebrowser : {
			 * action : "Browse", target : "Link:txtUrl", url :
			 * c.config.filebrowserImageBrowseLinkUrl }, style : "float:right",
			 * hidden : !0, label : c.lang.common.browseServer }, { id :
			 * "cmbTarget", type : "select", requiredContent : "a[target]",
			 * label : c.lang.common.target, "default" : "", items :
			 * [[c.lang.common.notSet, ""], [c.lang.common.targetNew, "_blank"],
			 * [c.lang.common.targetTop, "_top"], [c.lang.common.targetSelf,
			 * "_self"], [c.lang.common.targetParent, "_parent"]], setup :
			 * function(a, b) { 2 == a && this.setValue(b.getAttribute("target") ||
			 * "") }, commit : function(a, b) { 2 == a && (this.getValue() ||
			 * this.isChanged()) && b.setAttribute("target", this.getValue()) } }] }, {
			 * id : "Upload", hidden : 0, filebrowser : "uploadButton", label :
			 * c.lang.image.upload, elements : [{ type : "file", id : "upload",
			 * label : c.lang.image.btnUpload, style : "height:40px", size : 38 }, {
			 * type : "fileButton", id : "uploadButton", filebrowser :
			 * "info:txtUrl", label : c.lang.image.btnUpload, "for" : ["Upload",
			 * "upload"] }] } , { id : "advanced", label :
			 * c.lang.common.advancedTab, elements : [{ type : "hbox", widths :
			 * ["50%", "25%", "25%"], children : [{ type : "text", id :
			 * "linkId", requiredContent : "img[id]", label : c.lang.common.id,
			 * setup : function(a, b) { a == f &&
			 * this.setValue(b.getAttribute("id")) }, commit : function(a, b) {
			 * a == f && (this.getValue() || this.isChanged()) &&
			 * b.setAttribute("id", this.getValue()) } }, { id : "cmbLangDir",
			 * type : "select", requiredContent : "img[dir]", style : "width :
			 * 100px;", label : c.lang.common.langDir, "default" : "", items :
			 * [[c.lang.common.notSet, ""], [c.lang.common.langDirLtr, "ltr"],
			 * [c.lang.common.langDirRtl, "rtl"]], setup : function(a, b) { a ==
			 * f && this.setValue(b.getAttribute("dir")) }, commit : function(a,
			 * b) { a == f && (this.getValue() || this.isChanged()) &&
			 * b.setAttribute("dir", this.getValue()) } }, { type : "text", id :
			 * "txtLangCode", requiredContent : "img[lang]", label :
			 * c.lang.common.langCode, "default" : "", setup : function(a, b) {
			 * a == f && this.setValue(b.getAttribute("lang")) }, commit :
			 * function(a, b) { a == f && (this.getValue() || this.isChanged()) &&
			 * b.setAttribute("lang", this.getValue()) } }] }, { type : "text",
			 * id : "txtGenLongDescr", requiredContent : "img[longdesc]", label :
			 * c.lang.common.longDescr, setup : function(a, b) { a == f &&
			 * this.setValue(b.getAttribute("longDesc")) }, commit : function(a,
			 * b) { a == f && (this.getValue() || this.isChanged()) &&
			 * b.setAttribute("longDesc", this.getValue()) } }, { type : "hbox",
			 * widths : ["50%", "50%"], children : [{ type : "text", id :
			 * "txtGenClass", requiredContent : "img(cke-xyz)", label :
			 * c.lang.common.cssClass, "default" : "", setup : function(a, b) {
			 * a == f && this.setValue(b.getAttribute("class")) }, commit :
			 * function(a, b) { a == f && (this.getValue() || this.isChanged()) &&
			 * b.setAttribute("class", this.getValue()) } }, { type : "text", id :
			 * "txtGenTitle", requiredContent : "img[title]", label :
			 * c.lang.common.advisoryTitle, "default" : "", onChange :
			 * function() { g(this.getDialog()) }, setup : function(a, b) { a ==
			 * f && this.setValue(b.getAttribute("title")) }, commit :
			 * function(a, b) { a == f ? (this.getValue() || this.isChanged()) &&
			 * b.setAttribute("title", this .getValue()) : 4 == a ?
			 * b.setAttribute("title", this .getValue()) : 8 == a &&
			 * b.removeAttribute("title") } }] }, { type : "text", id :
			 * "txtdlgGenStyle", requiredContent : "img{cke-xyz}", label :
			 * c.lang.common.cssStyle, validate : CKEDITOR.dialog.validate
			 * .inlineStyle(c.lang.common.invalidInlineStyle), "default" : "",
			 * setup : function(a, b) { if (a == f) { var c =
			 * b.getAttribute("style"); !c && b.$.style.cssText && (c =
			 * b.$.style.cssText); this.setValue(c); var e = b.$.style.height, c =
			 * b.$.style.width, e = (e ? e : "").match(k), c = (c ? c :
			 * "").match(k); this.attributesInStyle = { height : !!e, width :
			 * !!c } } }, onChange : function() { i .call( this, "info:cmbFloat
			 * info:cmbAlign info:txtVSpace info:txtHSpace info:txtBorder
			 * info:txtWidth info:txtHeight" .split(" ")); g(this) }, commit :
			 * function(a, b) { a == f && (this.getValue() || this.isChanged()) &&
