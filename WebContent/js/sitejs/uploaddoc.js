...
var insertimg = function() {
	...
	var img = "<img src=\"getimg.do?imgid="
			+ imgid + "\"/><br>";
		...
		success : function(data) { // 请求成功后处理函数。
			...
			for (var i in data.photoList) {
				albumlistHtml = albumlistHtml
						...
						+ data.photoList[i].imgid + '\"></a><input type=\"radio\" name=\"imgradio\" id=\"'+data.photoList[i].imgid+'\"></div>';
